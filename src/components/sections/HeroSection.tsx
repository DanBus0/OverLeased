...
export default function HeroSection() {
  ...
  return (
    <section className="relative bg-blue-50 pt-6 md:pt-6 pb-12 md:pb-16 px-4">
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-8 md:mb-12">
          {/* Trust Indicator */}
          <div className="flex justify-center mb-4 md:mb-6">
            <div className="inline-flex items-center gap-1.5 px-2 py-1 md:px-3 md:py-2 bg-blue-50 border border-slate-300 rounded-lg shadow-sm">
          ...
          <div className="hidden md:block mb-6">
            <div className="bg-white/95 backdrop-blur-sm border-2 border-slate-200/80 rounded-2xl shadow-md py-10 px-8 max-w-7xl mx-auto">
              ...
              <h1 className="text-[2.75rem] lg:text-6xl font-bold mb-0 leading-tight block lg:hidden text-slate-900">
                ...
                <span className="flex items-center justify-center gap-3 text-slate-600 -mt-1 text-[2.25rem] font-normal">
              ...
              <h1 className="text-[4rem] font-bold leading-tight hidden lg:block text-slate-900 mb-0">
                <span className="block">End Your Car Lease Early</span>
                <span className="flex items-center justify-center gap-3 text-slate-600 -mt-1 text-[2.75rem] font-normal">
              ...
              {/* CTA Section - Now inside desktop title box */}
          ...
          <div className="block md:hidden mt-2.5 mb-6 px-2">
            <div className="bg-white/95 backdrop-blur-sm border-2 border-slate-200/80 rounded-2xl shadow-md pt-5 px-7 pb-7 max-w-[350px] mx-auto">
              {/* Hero Title - Mobile Only */}
              <div className="text-center mb-4">
                <h1 className="text-[2.375rem] sm:text-[3rem] font-bold leading-[1.1] sm:leading-tight text-slate-900">
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-2 px-2 py-2.5 bg-slate-50 rounded-lg border-[0.5px] border-slate-200 w-full">
                  <div className="flex-shrink-0 w-4 h-4 bg-white rounded-full flex items-center justify-center shadow-sm border-2 border-blue-600">
                    <Check className="h-2.5 w-2.5 text-blue-600" strokeWidth={3} />
                  </div>
          ...
          {/* Mobile CTA Box - Below callouts */}
          <div className="block md:hidden mb-6 px-2">
            <div className="bg-white rounded-2xl shadow-lg border border-blue-400/60 p-7 max-w-[350px] mx-auto ring-1 ring-blue-200/50 hover:border-blue-500/70 hover:shadow-xl transition-all duration-300">
              <div className="text-center mb-3">
              ...
              <div className="flex justify-center mb-3">
                <Link
                  ...
                  className="inline-flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white text-base px-8 py-3 shadow-lg transition-colors duration-200 font-bold rounded-2xl border-0"
                >
                  Check If You Qualify
                  <Search className="ml-2.5 h-4 w-4" />
                </Link>
              </div>
              <p className="text-sm text-slate-600 font-medium text-center">
                Takes less than a minute —<br />no commitment required.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="relative">
          ...
          <div className="block md:hidden">
            <div className="bg-white backdrop-blur-sm border-2 border-slate-200/80 rounded-2xl shadow-md py-7 px-8 max-w-7xl mx-auto">
              ...
              <Accordion type="single" collapsible className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
